...
class Driver:
    ...
    def __repr__(self):
        return "02_Nile Driver speed {} salary {}".format(self.speed, self.salary)
...
def test_driver(f):
    ...
    if price != 200:
        print(
            "calculate_driver_cost() did not provide correct final price (expected {}, received {})".format(200, price))
        return
