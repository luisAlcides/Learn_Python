...
def getCard(deckListIn):
    thisCard = deckListIn.pop()  # pop() one off the top of the deck an return
    return thisCard
...
while True:
    ...
    for cardNumber in range(0, NCARDS):  # play one game of this many cards
        ...
        asnwer = answer.casefold()  #force lowercase
    ...
    goAgain = input('Do you want to play again? (press ENTER or q) to quit: ')
    if goAgain == 'q':
        break
    print('OK bye!')
